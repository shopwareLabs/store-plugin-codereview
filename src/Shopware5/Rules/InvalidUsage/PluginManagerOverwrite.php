...
class PluginManagerOverwrite implements Rule
{
    ...
    public function processNode(Node $node, Scope $scope): array
    {
        ...
        if (
            ...
            return [
                'It is not allowed to modifiy the plugin manager. For more information please look at https://docs.shopware.com/en/plugin-standard-for-community-store#it-is-not-allowed-to-extend-the-plugin-manager'
            ];
        }
